<?php
	...
	use Domi\Bundle\AdresseBundle\Form\AdresseType;
	...
	class AdresseController extends Controller {
		...
		public function indexAction(Request $request, $page) {
			...
			$entities = $em->getRepository('DomiAdresseBundle:Adresse');


			// $qb instanceof QueryBuilder
			$qb = $entities->createQueryBuilder('p');
			...
			return $this->render('DomiAdresseBundle:Adresse:index.html.twig',
		...
		public function createAction(Request $request) {
			...
			return $this->render('DomiAdresseBundle:Adresse:new.html.twig',
			                     array(
				                     'entity' => $entity,
		...
		private function createCreateForm(Adresse $entity) {
			...
			$form->add('submit', 'submit', array('label' => 'Create from createCreateForm'));
		...
		public function showAction(Request $request, $id) {
			$em     = $this->getDoctrine()->getManager('adresse');
			$entity = $em->getRepository('DomiAdresseBundle:Adresse')->find($id);
			if (!$entity) {
				throw $this->createNotFoundException('Unable to find Adresse entity.');
			}
			$deleteForm = $this->createDeleteForm($id);
//	dump($form);die;
			return $this->render('DomiAdresseBundle:Adresse:show.html.twig',
			                     array(
				                     'entity'      => $entity,
		...
		public function editAction($id, Request $request) {
			if (!$id) {
				throw $this->createNotFoundException('Pas d\'Adresse trouvée = ' . $id);
			}
			$em        = $this->getDoctrine()->getManager('adresse');
			$entity    = $em->getRepository('DomiAdresseBundle:Adresse')->find($id);
			$edit_form = $this->createForm(new AdresseType(), $entity);
//	dump($form);die;
			$edit_form->handleRequest($request);
			if ($edit_form->isValid()) {
				$em->flush();
				$request->getSession()->getFlashBag()->add('notice', 'Adresse bien enregistréee.');

				return $this->redirect($this->generateUrl('adresse'));
			}

			return $this->render('DomiAdresseBundle:Adresse:form.html.twig',
			                     array(
		...
		private function createEditForm(Adresse $entity) {
			$form = $this->createForm(new AdresseType(),
			                          $entity,
			                          array(
				                          'action' => $this->generateUrl('adresse_update',
		...
		public function updateAction(Request $request, $id) {
			...
			return $this->render('DomiAdresseBundle:Adresse:edit.html.twig',
			                     array(
				                     'entity'      => $entity,
